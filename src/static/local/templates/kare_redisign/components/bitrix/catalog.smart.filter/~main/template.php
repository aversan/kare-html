	...
	<div class="bx_filter_vertical">
		<div class="bx_filter_section m4">
			<form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smartfilter">
				<div class="filter_reset"><button class="filter_button clear_filter" type="submit" id="del_filter" name="del_filter" value="<?=GetMessage("CT_BCSF_DEL_FILTER")?>" /><span><?=GetMessage("CT_BCSF_DEL_FILTER")?></span></button></div>
