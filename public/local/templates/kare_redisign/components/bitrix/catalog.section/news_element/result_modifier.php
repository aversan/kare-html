...
//region Custom region (get basket items)
$itemIds = [
	'DELAY' => [],
	'ADDED' => [],
];
...
if (!empty($arResult['ITEMS']))
{
	...
	foreach ($arResult['ITEMS'] as $key => $arItem)
	{
		...
		// cycle custom
		$arItem['PROPERTIES']['MAIN_PHOTO']['VALUE'] = ($arItem['PROPERTIES']['MAIN_PHOTO']['VALUE'][0] == '/') ? $arItem['PROPERTIES']['MAIN_PHOTO']['VALUE'] : '/' . $arItem['PROPERTIES']['MAIN_PHOTO']['VALUE'];
...
// custom start
$arResult['strElementEdit'] = CIBlock::GetArrayByID($arParams["IBLOCK_ID"], "ELEMENT_EDIT");
$arResult['strElementDelete'] = CIBlock::GetArrayByID($arParams["IBLOCK_ID"], "ELEMENT_DELETE");
$arResult['arElementDeleteParams'] = array("CONFIRM" => GetMessage('CT_BCS_TPL_ELEMENT_DELETE_CONFIRM'));