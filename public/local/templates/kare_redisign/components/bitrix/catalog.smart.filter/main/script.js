...
JCSmartFilter.prototype.click = function(checkbox)
{
	...
	console.log("JCSmartFilter.prototype.click")
}
...
cDoubleTrackBar.prototype = {
	...
	UpdateTracker: function(X){
		...
		var _oldMin = this.MinPos = this.MinInputId.value;
		var _oldMax = this.MaxPos = this.MaxInputId.value;
		...
		if (this.Left) {
			...
			*/
			...
			this.RightDrag.style.left = (((this.MaxPos - this.Min) * 100) / (this.Max - this.Min)).toFixed(2) +  "%";
			this.Tracker.style.width = (((this.MaxPos - this.MinPos) * 100) / (this.Max - this.Min)).toFixed(2) + "%";
